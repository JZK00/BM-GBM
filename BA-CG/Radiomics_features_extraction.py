...
def main():
  # outPath = r'E:/project/pyradiomics-master/'
  outPath = r'./data/output'


  inputCSV = os.path.join('./data', 't1_feature.csv')
  outputFilepath = os.path.join(outPath, 'Remove redundant features.csv')
  progress_filename = os.path.join(outPath, 'pyrad_log.txt')
  # params = os.path.join(outPath,'examples', 'exampleSettings', 'Params.yaml')
  params = './Radiomics Params.yaml'
